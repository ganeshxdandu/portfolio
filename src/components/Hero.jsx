                ...
                >
                    ...
                    <div className="info flex justify-between items-start flex-col py-1 sm:py-2">
                        ...
                        <div className="top">
                            ...
                            <div className="h-5 overflow-hidden text-[#4d4d4d] tracking-tight text-[14px] font-outfit font-light pl-px">
                        ...
                        <motion.div
                            ...
                            className="group flex items-center gap-2.5 w-max mt-4 px-3 py-1 rounded-full bg-[#FAFAFA] border border-[#ECECEC] transition-all duration-300 hover:bg-white hover:border-[#DDDDDD]"
                        >
                            <span className="relative flex h-2 w-2">
                                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#22C55E] opacity-50"></span>

                                <span className="relative inline-flex h-2 w-2 rounded-full bg-[#22C55E]"></span>
                            </span>

                            <span className="text-[12px] text-[#525252] tracking-tight font-outfit">
